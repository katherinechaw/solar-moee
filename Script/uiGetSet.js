...
////////////////////////////////// Load Dropdown //////////////////////////////////
function fnLoadDropDownNumber(sObjectCSSID, fn, nStart, nEnd, bIncludeZeroItem, arrAdditionalVals, nDefaultVal)
{
	var o = $("." + sObjectCSSID);
...
{
	//clsNightTimeHrs
   	fnLoadDropDownNumber("clsNightTimeHrs", function(n) {return n + " နာရီ"}, 1, 16, true, ["0.5"], 0)
	
	//clsDayTimeHrs
   	fnLoadDropDownNumber("clsDayTimeHrs", function(n) {return n + " နာရီ"}, 1, 8, true, ["0.5"], 0)
	
	//clsBlackoutTimeHrs
   	fnLoadDropDownNumber("clsBlackoutTimeHrs", function(n) {return n + " နာရီ"}, 1, 24, true, ["0.5"], 0)	

	//clsBlackoutHr
   	fnLoadDropDownNumber("clsBlackoutHr", function(n) {return n + " နာရီ"}, 1, 24, true, null, 5)	
	
	//clsQuantity
   	fnLoadDropDownNumber("clsQuantity", function(n) {return n}, 1, 20, false, null, 1)	
